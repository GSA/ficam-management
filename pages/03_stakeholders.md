...
A stakeholder is an individual or organization that is either actively involved in a program or who might be affected by the program’s execution or completion. It’s critical that you identify all stakeholders, and not just those who may be positively affected by the project, in order to understand the needs, responsibilities, and potential impacts of program decisions. We’ve identified key ICAM stakeholders at the federal and agency level for consideration. This list is not exhaustive and agencies will need to identify the unique stakeholders for their mission delivery.

* [Federal Governance Bodies](#federal-governance-bodies)
* [Internal Standards Body](#internal-standards-body)
* [External Industry Guidance and Standards Bodies](#external-industry-guidance-and-standards-bodies)
* [ICAM Service Providers](#icam-service-providers)
* [Internal Service Customers](#internal-service-customers)
...
| [Identity Credential and Access Management Subcommittee (ICAMSC)](https://www.idmanagement.gov/icamsc/){:target="_blank"} | • Principal interagency forum for identity management, secure access, authentication, authorization, credentials, privileges, and access lifecycle management. A sub-committee to the Federal CIO and Federal CISO.<br><br> • Provides opportunities for agencies to raise issues and challenges associated with the planning, implementation, and operations of ICAM programs and solutions.<br><br> • Recommends new ICAM policies and updates existing ones.<br><br> • Develops specific tools to assist agencies ability to meet ICAM policy objectives and overcome identified ICAM implementation challenges.<br><br> • Acts as a vehicle for cross-government collaboration on information sharing, lessons learned, and best practices related to ICAM. |
...
| [Department of Homeland Security (DHS)](https://www.dhs.gov/){:targe t="-blank"} | Oversees government-wide and agency-specific cybersecurity implementation and reporting with respect to information systems that fall under FISMA to provide adequate, risk-based, and cost- effective cybersecurity. |
| [General Services Administration (GSA)](https://www.gsa.gov/){:target="_blank"} <br> NOTE: GSA is also an Internal Service Provider | <u>Government-wide Policy and Implementation </u><br><br> • Federal Identity, Credential, and Access Management (FICAM) Program: <br><br>- Helps federal agencies enable access to systems and facilities for the right person, at the right time, for the right reason. <br> <br> - Supports federal agencies through the entire identity management lifecycle.<br><br> - Works with vendors to test and approve ID management products and services for use by the federal government. <br><br> <u> ICAM Shared Services</u> <br><br> • USAccess HSPD-12 Managed Service Program: Provides agencies with a PIV credentialing service. <br><br> • Login.gov: A shared government single sign on (SSO) service that allows public consumers to securely access federal government services. <br><br>  • Federal Public Key Infrastructure (FPKI) Program: Provides the government with a trust framework and infrastructure to administer digital certificates and public-private key pairs. <br><br> <u>ICAM Acquisition</u> <br><br> • Establishes and maintains vehicles and products for HSPD-12 deployment and provides USAccess HSPD-12 Managed Service Offering. |
...
| [Secure Technology Alliance](https://www.securetechalliance.org/alliance/){:target="blank"} | • Digital security industry association with a mission to stimulate understanding, adoption, and widespread application of connected digital solutions based on secure chip and other technologies and systems needed to protect data, enable secure authentication and facilitate commerce. <br><br> • Recognized industry-wide for its objective training and certification programs on secure solutions and their implementation within digital security industries.|
| [Security Industry Association (SIA)](https://www.securityindustry.org/){:target="blank"} | • Non-profit international trade association representing electronic and physical security product manufacturers, distributors, integrators, and service providers <br><br> • SIA is an American National Standards Institute (ANSI)-approved Standards Development Organization involved in developing systems integration and equipment performance standards. |
| [TechAmerica](https://www.techamerica.org/){:target="blank"} | High-tech industry association active in Federal Information Security policy issues. |
| [Transglobal Secure Collaboration Program (TSCP)](https://www.tscp.org/about-tscp/){:target="blank"} | • Government-industry partnership focused on facilitating solutions for Aerospace and Defense issues <br><br> • Currently working on identity federation issues in international defense and aerospace programs. |
